...
gastos em uma viagem, ao utilizar um automóvel 
que faz 12 KM/L. Para isso, ele gostaria que você o auxiliasse 
através de um simples programa. Para efetuar o cálculo, deve-se fornecer o tempo 
gasto na viagem (em horas) e a velocidade média durante a mesma (em km/h). 
...
gasto_combustivel_automovel = 12

distancia_em_km = velocidade_media * tempo_viagem_horas
litros = distancia_em_km / gasto_combustivel_automovel
